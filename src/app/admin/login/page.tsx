...
export default function AdminLogin() {
  ...
  return (
    <div className=" hidden md:flex ">
          ...
          >
            ...
            >
              ...
              <Form.Item name="remember" valuePropName="checked">
                ...
                >
                  <Checkbox style={{ fontWeight: 500, color: "#4a5568" }}>
                    Remember me
                  </Checkbox>
                  <Button
                    type="link"
                    style={{ padding: 0, fontWeight: 600, color: "#2d3748" }}
                  >
                    Forgot password?
                  </Button>
                </div>
      ...
      <div className=" flex md:hidden items-center justify-between w-full h-screen">
        <h1 className=" text-white ">
          Please Open This On a Computer to Access the CBPD admin dashboard
        </h1>
      </div>
    </div>
  );
