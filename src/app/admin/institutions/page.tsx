...
export default function InstitutionsManagement() {
    ...
    try {
      ...
      if (format === "csv") {
        const response = await fetch(
          `/api/admin/institutions/export?${queryParams}`
        );
        if (response.ok) {
          ...
          a.href = url;
          a.download = `institutions_export_${
  ...
  const pendingCount = institutions.filter(
    (inst) => !inst.isApproved && !inst.isTerminated
  ).length;
  const approvedCount = institutions.filter(
    (inst) => inst.isApproved && !inst.isTerminated
  ).length;
  const terminatedCount = institutions.filter(
    (inst) => inst.isTerminated
  ).length;
      ...
      <div style={{ padding: "24px" }}>
        ...
        <Row gutter={[24, 24]} style={{ marginBottom: 32 }}>
          <Col xs={24} sm={6}>
            ...
            >
              <BankOutlined
                style={{ fontSize: 32, color: "#495057", marginBottom: 16 }}
              />
              <Statistic
                title={
          ...
          <Col xs={24} sm={6}>
            ...
            >
              <CheckCircleOutlined
                style={{ fontSize: 32, color: "#28a745", marginBottom: 16 }}
              />
              <Statistic
                title={
                  <span style={{ color: "#6c757d", fontWeight: 600 }}>
          ...
          <Col xs={24} sm={6}>
            ...
            >
              <ClockCircleOutlined
                style={{ fontSize: 32, color: "#ffc107", marginBottom: 16 }}
              />
              <Statistic
                title={
                  <span style={{ color: "#6c757d", fontWeight: 600 }}>
          ...
          <Col xs={24} sm={6}>
            ...
            >
              <StopOutlined
                style={{ fontSize: 32, color: "#dc3545", marginBottom: 16 }}
              />
              <Statistic
                title={
                  <span style={{ color: "#6c757d", fontWeight: 600 }}>
        ...
        >
          {selectedInstitution && (
            <div>
                ...
                <Col span={8}>
                  ...
                  >
                    ...
                    <Statistic
                      title="Departments"
                      value={
                        selectedInstitution.statistics?.departmentStats
                          ?.length || 0
                      }
                      valueStyle={{
                        color: "#faad14",
              ...
              >
                <Descriptions column={1} bordered size="small">
                  ...
                  <Descriptions.Item label="Address">
                    {selectedInstitution.businessAddress},{" "}
              ...
              >
                <Descriptions column={1} bordered size="small">
                  <Descriptions.Item label="Name">
                    <Text strong>
                      {selectedInstitution.firstName}{" "}
                      {selectedInstitution.lastName}
                    </Text>
                  </Descriptions.Item>
              ...
              {/* Secondary Contact */}
              {(selectedInstitution.SfirstName ||
                selectedInstitution.SlastName) && (
                <Card
        ...
        >
          ...
          >
                ...
                <Col span={12}>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter industry sector",
                      },
                    ]}
                  >
                    <Input style={{ borderRadius: 8 }} />
              ...
              <Row gutter={16}>
                ...
                <Col span={12}>
                  <Form.Item
                    ...
                    rules={[
                      { required: true, message: "Please enter telephone" },
                    ]}
                  >
                    <Input style={{ borderRadius: 8 }} />
                  </Form.Item>
            ...
            <Card
              title="Secondary Contact Person (Optional)"
              style={{ marginBottom: 24, borderRadius: 12 }}
            >
              <Row gutter={16}>
                <Col span={8}>
                  <Form.Item name="SfirstName" label="First Name">
                    <Input style={{ borderRadius: 8 }} />
                  </Form.Item>
                </Col>
                <Col span={8}>
                  <Form.Item name="SlastName" label="Last Name">
                    <Input style={{ borderRadius: 8 }} />
                  </Form.Item>
                </Col>
                <Col span={8}>
                  <Form.Item name="SjobTitle" label="Job Title">
                    <Input style={{ borderRadius: 8 }} />
                  </Form.Item>
                </Col>
              </Row>
              ...
              <Row gutter={16}>
                ...
                <Col span={8}>
                  <Form.Item name="SphoneNumber" label="Phone Number">
                    <Input style={{ borderRadius: 8 }} />
                  </Form.Item>
                </Col>
                <Col span={8}>
                  <Form.Item name="SmobileNumber" label="Mobile Number">
                    <Input style={{ borderRadius: 8 }} />
                  </Form.Item>
                </Col>
              </Row>
