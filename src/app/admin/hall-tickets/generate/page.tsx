                  ...
                  <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "20px", fontSize: "14px", fontWeight: "bold" }}>
                    <tbody>
                      <tr>
                        ...
                        <td style={{ border: "1px solid #000", padding: "10px", textTransform: "uppercase" }}>{ticketData.candidateName}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>DATE OF BIRTH</td>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>{ticketData.dateOfBirth}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>COURSE</td>
                        <td style={{ border: "1px solid #000", padding: "10px", textTransform: "uppercase" }}>{ticketData.course}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>COURSE DURATION</td>
                        <td style={{ border: "1px solid #000", padding: "10px", textTransform: "uppercase" }}>{ticketData.courseDuration}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>EXAMINATION CENTRE</td>
                        <td style={{ border: "1px solid #000", padding: "10px", textTransform: "uppercase" }}>{ticketData.examinationCentre}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>EXAMINATION DATE</td>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>{ticketData.examinationDate}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>EXAMINATION TIME</td>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>{ticketData.examinationTime}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>EXAMINATION TEST CODE</td>
                        <td style={{ border: "1px solid #000", padding: "10px" }}>{ticketData.examinationTestCode}</td>
                      </tr>
                    </tbody>
                  </table>
                    ...
                    <table style={{ borderCollapse: "collapse", width: "60%", fontSize: "14px", fontWeight: "bold" }}>
                      <tbody>
                        <tr>
                          ...
                          <td style={{ border: "2px solid #000", padding: "10px", textAlign: "center" }}>{ticketData.rollNumber}</td>
                        </tr>
                      </tbody>
                    </table>
                    
                    <div style={{ width: "150px", height: "180px", border: "1px solid #ccc", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", background: "#f5f5f5", color: "#999" }}>
