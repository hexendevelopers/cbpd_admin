                  ...
                  <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "10px", fontSize: "14px", fontWeight: "bold" }}>
                    <tbody>
                      <tr>
                        ...
                        <td style={{ border: "1px solid #000", padding: "6px", textTransform: "uppercase" }}>{ticketData.candidateName}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>DATE OF BIRTH</td>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>{ticketData.dateOfBirth}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>COURSE</td>
                        <td style={{ border: "1px solid #000", padding: "6px", textTransform: "uppercase" }}>{ticketData.course}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>COURSE DURATION</td>
                        <td style={{ border: "1px solid #000", padding: "6px", textTransform: "uppercase" }}>{ticketData.courseDuration}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>EXAMINATION CENTRE</td>
                        <td style={{ border: "1px solid #000", padding: "6px", textTransform: "uppercase" }}>{ticketData.examinationCentre}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>EXAMINATION DATE</td>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>{ticketData.examinationDate}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>EXAMINATION TIME</td>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>{ticketData.examinationTime}</td>
                      </tr>
                      <tr>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>EXAMINATION TEST CODE</td>
                        <td style={{ border: "1px solid #000", padding: "6px" }}>{ticketData.examinationTestCode}</td>
                      </tr>
                    </tbody>
                  </table>
                    ...
                    <table style={{ borderCollapse: "collapse", width: "55%", fontSize: "14px", fontWeight: "bold" }}>
                      <tbody>
                        <tr>
                          ...
                          <td style={{ border: "2px solid #000", padding: "8px", textAlign: "center" }}>{ticketData.rollNumber}</td>
                        </tr>
                      </tbody>
                    </table>
